...
<br><br>
<div class="usu-conf">
<h3>Termine a configuração de seu perfil de brechó, é rápidinho!</h3>
...
<p> Qual o nome do seu brechó?</p> 
<input type="text" name="txtnomebre"> 
...
<p> Fale sobre seu brechó: </p>
<input type="text-box" name="biografia">

<p> Agora, seu cpf pessoal (não é preciso CNPJ): </p> 
