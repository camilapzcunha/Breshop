    ...
    <div class="profile-header">
        ...
        <div class="profile-header-content">
            ...
            <div class="profile-header-info">
                ...
                <p class="m-b-sm">Olá! Você é um vendedor BRESHOP!</p>
                <a href="#" class="btn btn-xs btn-primary mb-4">Editar Perfil</a>
            </div>
        </div>

                  <ul class="profile-header-tab nav nav-tabs">
                     <li class="nav-item"><a href="comentariosbre.php" target="__blank" class="nav-link_">COMENTÁRIOS</a></li>
                     <li class="nav-item"><a href="https://www.bootdey.com/snippets/view/bs4-profile-about" target="__blank" class="nav-link_">SOBRE</a></li>
                     <li class="nav-item"><a href="https://www.bootdey.com/snippets/view/profile-photos" target="__blank" class="nav-link_ active show  ">PRODUTOS PUBLICADOS</a></li>
                  </ul>
    </div>
        ...
        <div class="row row-space-20">
            <div class="col-md-8">
                <div class="tab-content p-0">
                    <h4> <i class="fas fa-plus" style="color: #4b793f"></i> <a href="publicarprod.php"> Publicar novo produto </a> </h4>
                    <div class="tab-pane active show" id="profile-photos">
                        <div class="m-b-10"><b>Produtos</b></div>
                
                        <ul class="img-grid-list">
                    <?php 
                    $cont=0;
                    while ($p2 = mysqli_fetch_array($prods))
                    {$cont++;
                    ...
                    $cont=1;
                         ...
                         <li>
                         <?php echo " <form method=post action='editarprod.php' name='verprods'> <a> <img src= http://localhost/oficial/img/$p2[9] class='img-portrait'/> </a>"; 
                         echo "<input type='hidden' name=codx value='$p2[0]'>";
                         echo "<input type='submit' class='btn btn-xs btn-primary mb-4' value='Veja mais'>";
                        echo "</form>"; 
            ...
            <div class="col-md-4 hidden-xs hidden-sm">
                <ul class="profile-info-list">
                    <li class="title">Informações Pessoais</li>
                    <li>
                        <div class="field">Perfil:</div>
                        <div class="value">Vendedor BRESHOP</div>
                    </li>
                    <li>
                        <div class="field">Nome do(a) vendedor(a):</div>
                        <div class="value"><?php echo $p[4]; ?> </div>
                    </li>
                    <li>
                        <div class="field">Entrou em:</div>
                        <div class="value"><?php echo $p[6]; ?></div>
                    </li>
                    <li>
                        <div class="field">Nome do Brechó:</div>
                        <div class="value"><?php echo $p[2]; ?></div>
                    </li>
                    <li>
                        <div class="field">Localizado em:</div>
                        <div class="value">
                            <address class="m-b-0">
                            <?php echo "$e[2] $e[3] $e[4], $e[6], $e[7], $e[8]"; ?>  
                            </address>
                        </div>
                    </li>
                    <li>
